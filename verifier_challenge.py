...
if __name__ == "__main__":
    ...
    if not images:
        ...
        plt.xlabel("Challenge Range Limit", fontsize=14)
        plt.ylabel("Number of Successful Verifications", fontsize=14)
        #plt.title("Successful Verifications with Decreasing Challenge Range")
        plt.legend(fontsize=12)
        plt.grid(True)
        plt.savefig('challenge_successful.png')
        ...
        plt.xlabel("Challenge Range Limit", fontsize=14)
        plt.ylabel("Number of Unsuccessful Verifications", fontsize=14)
        #plt.title("Unsuccessful Verifications with Decreasing Challenge Range")
        plt.legend(fontsize=12)
        plt.grid(True)
        plt.savefig('challenge_unsuccessful.png')
